...
public class HttpOutboundHandler {
    ...
    public void handle(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx) {
        ...
        // 替换自己的httpclient
        proxyService.submit(()->zhouHaoFetchGet(fullRequest, ctx, url));
    }

    private void zhouHaoFetchGet(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx, final String url) {
        ...
        try {
            ...
            if (httpResponse.getStatusLine().getStatusCode() == HttpStatus.SC_OK) {
                ...
                System.out.println("获取远程返回数据：" + result);
